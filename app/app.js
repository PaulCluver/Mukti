(function () {
	...
	yogaApp.config(function($stateProvider, $urlRouterProvider) {
	    ...
	    $stateProvider
			.state('home', { url: "/home", templateUrl: "partials/home/home.html", controller: "homeCtrl"})
			.state('hatha', { url: "/hatha", templateUrl: "partials/yoga/hatha/hatha.html" })
			.state('ashtanga', {url: "/ashtanga", templateUrl: "partials/yoga/ashtanga/ashtanga.html" })
			.state('vinyasa', {url: "/vinyasa", templateUrl: "partials/yoga/vinyasa/vinyasa.html" })
			.state('workshops', { url: "/workshops", templateUrl: "partials/schedule/workshops/workshops.html", controller: "workshopCtrl" })
			.state('classes', { url: "/classes", templateUrl: "partials/schedule/classes/classes.html", controller: "classesCtrl" })
			.state('contact', { url: "/contact", templateUrl: "partials/user/contact/contact.html", controller: "contactCtrl"})
			.state('login', { url: "/login", templateUrl: "partials/user/login/login.html" })
			.state('logout', { url: "/logout", templateUrl: "partials/user/logout/logout.html" })
			.state('register', { url: "/register", templateUrl: "partials/user/register/register.html" })
	});
